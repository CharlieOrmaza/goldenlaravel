...
<script type="text/javascript">
	...
	<div class="panel panel-success">
  		<div class="panel-heading">
  			<h4>Actualizar Circuitos</h4>
  		</div>
                 
  		<div class="panel-body">
  			@if (!empty($circuitos))
    			<form method="post" action="/circuitos/update/{{ $circuitos->id }}">
		            <p>
						<h3>Papeleta</h3><hr>
					</p>
		          	<p>
				    ...
				    <table class="table">
                    	...
                    	<tbody>
				        	...
				        	<tr>
				        		<th>
				        			<input  value="{{ $circuitos->operador  }}" type="text" name="ope"  placeholder="Operador" class="form-control" required>
				        		</th>
				        		<th>
				      				<input value="{{ $circuitos->operadorMayorista}}" type="text" name="opeM" placeholder="Operador Mayorista" class="form-control" required>
				      			</th>
				      			<th>
				      				 <input value="{{ $circuitos->numeroPersonas }}" type="number" placeholder="Numero de Personas" name="numeroPersonas"  class="form-control" required>
				      			</th>
				        	</tr>
				        <tbody>
                    </table>
                    <p>
		            	Nombre del Circuito: <input value="{{ $circuitos->nombreCircuito }}" type="text" name="nameC" placeholder="Nombre del Circuito"  class="form-control" required>
		          	</p>
		          	<p>
		            	Descripcion del Circuito: 
		            	<textarea  name="desC" placeholder="Descripcion del Circuito" class="form-control" >{{ $circuitos->descripcionCircuito}}</textarea>
		          	</p>
		          	<hr>
	  				<p>
            ...
            @else
	              	 <p>
	                	No existe información para este Circuito.
	             	</p>
          	 @endif
