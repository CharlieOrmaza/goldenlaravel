...
<script type="text/javascript">
	...
	<div class="panel panel-success">
  		<div class="panel-heading">
  			<h4>Actualizar Renta de Autos</h4>
  		</div>
                 
  		<div class="panel-body">
  			@if (!empty($autosrentas))
    			<form method="post" action="/Autosrentas/update/{{ $autosrentas->id }}">
		            <p>
						<h3>Papeleta</h3><hr>
					</p>
		          	<p>
				    ...
				    <table class="table">
                    	...
                    	<tbody>
				        	...
				        	<tr>
				        		<th>
				        			<input  value="{{ $autosrentas->operador  }}" type="text" name="ope"  placeholder="Operador" class="form-control" required>
				        		</th>
				        		<th>
				      				<input value="{{ $autosrentas->arrendadora}}" type="text" name="arrendadora" placeholder="Arrendadora" class="form-control" required>
				      			</th>
				      			<th>
				      				 <input value="{{ $autosrentas->tipoDeAuto }}" type="text" placeholder="Tipo de Auto" name="tipoDeAuto"  class="form-control" required>
				      			</th>
				        	</tr>
				        <tbody>
                    </table>
                    <table class="table">
                    	...
                    	<tbody>
				        	<tr>
				      			...
				      			<th>
				      				Clave de la Arrendadora: 
				      			</th>
				        	</tr>
				        	<tr>
				        		<th>
				        			<input  value="{{ $autosrentas->fechaEntraga  }}" type="date" name="fechaEntraga"  placeholder="Fecha de Entraga" class="form-control" required>
				        		</th>
				        		<th>
				      				<input value="{{ $autosrentas->fechaDevolucion}}" type="date" name="fechaDevolucion" placeholder="Fecha de Devolucion" class="form-control" required>
				      			</th>
				      			<th>
				      				 <input value="{{ $autosrentas->claveOperador }}" type="text" placeholder="Clave del Operador" name="claveOperador"  class="form-control" required>
				      			</th>
				      			<th>
				      				 <input value="{{ $autosrentas->claveArrendadora }}" type="text" placeholder="Clave de la Arrendadora" name="claveArrendadora"  class="form-control" required>
				      			</th>
				        	</tr>
				        <tbody>
                    </table>
                    ...
                    <p>
		            	Lugar y Hora de la Entrega:
		            	<textarea  name="LugaryhoraDeEntrega" placeholder="Lugar y Hora De Entrega" class="form-control" >{{ $autosrentas->LugaryhoraDeEntrega }}</textarea>
		          	</p> 
		          	<p>
		            	Lugar y Hora de la Devolucion:
		            	<textarea  name="LugaryhoraDeDevolucion" placeholder="Lugar y Hora De Devolucion" class="form-control" >{{ $autosrentas->LugaryhoraDeDevolucion }}</textarea>
		          	</p>
            ...
            @else
	              	 <p>
	                	No existe información para esta Renta.
	             	</p>
          	 @endif
